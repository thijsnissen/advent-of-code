...
class Test extends AnyFunSuite:
	test("Test"):
		...
		// val r = Utilities.cycleSeq(Vector.range(1, 11))
		//
		// println(r(3))
		// println(r(-7))
		// println(r(33))
		...
		// pprint.log(Cycle.find(a, 0)(identity))

		// assertResult(Cycle(5, 6, 5, 10))(Cycle.find(a, 0)(identity))
		...
		// import JSON.*
		//
		// pprint.pprintln(JSON.json.run(jsonTxt))
		// pprint.pprintln(JSON.json.run(malformedJson))
